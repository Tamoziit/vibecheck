"use client"; //as we cannot use a hook(useTheme()) in a server component, we need to specify the page to be client compnent. (By default every component is server component)
import { MoonIcon, SunIcon, Volume2, VolumeX } from "lucide-react"; //shad-cn package providing default icons
