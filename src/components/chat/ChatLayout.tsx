...
interface ChatLayoutProps {
    ...
    users: User[]; //array of type User {...}
}

const ChatLayout = ({ defaultLayout = [320, 480], users }: ChatLayoutProps) => { //{defaultLayout=[320, 480]}:ChatLayoutProps) --> defines the type of defaultLayout & sets its default value to be [320px, 480px]
                    ...
                    <div className="flex justify-center items-center h-full w-full px-10">
                        <div className="flex flex-col justify-center items-center gp-4">
                            {theme === "dark" ? (
                                ...
                                <img src="/logo-inverted.png" alt='Logo' className="w-full md:w-2/3 lg:w-1/2" />
                            )}
